class PessoasController < ApplicationController
  ...
  # GET /pessoas.json
  def index
    # O params[:page] nos informa a página em que estamos, já o per informa quantos itens queremos mostrar por página. No nosso caso, mostramos duas pessoas por página.
    @pessoas = Pessoa.page(params[:page]).per(2)
  end
